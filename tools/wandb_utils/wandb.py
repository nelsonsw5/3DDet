...
class WandB:
    ...
    def get_img_log(self, fpath_or_list, key="Key Frames"):
        """
    ...
    @staticmethod
    def get_bb_dict(centroids, dims, colors=None, labels=None):
        """
        ...
        for i, c in enumerate(centroids):
            ...
            box_arr_corners = bb.get_corners()
            #pdb.set_trace()
            box_arr = box_arr_corners.transpose()
    ...
    @staticmethod
    def get_bb_dict_from_bb(corners, colors=None, labels=None):
        """
        helper function to get wandb bb format
        """
        boxes = []
        for i, box in enumerate(corners):
            ...
            # print("bb corners: ", bb.corners)
            box_arr_corners = np.array(bb.get_corners())
            #pdb.set_trace()
            box_arr = box_arr_corners.transpose()
            # box_arr = box_arr_corners
            # expects corners as list of tuples:
            # [
            #   (x1, y1, z1),
            #   (x2, y2, z2),
